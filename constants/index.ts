...
export const resumeLink: string = "https://drive.google.com/file/d/1FsvQdDXy056qEoVBbaFc2mcFz7ESj7HH/view?usp=sharing";
...
export { experiences, projects, navLinks, bioParagraphs, skills, heroText, testimonials };
