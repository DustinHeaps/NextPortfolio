...
export const projects: ProjectProps[] = [
  {
    id: 1,
    title: "Waivify",
    image: "/assets/images/waivify.png",
    description: `A digital waiver management app for solo service providers and small businesses. Users can collect signatures, manage submissions, and export signed waivers with ease. The dashboard includes filtering, CSV export, and branding tools—no coding required.`,
    technologies: [
      "NextJS 15",
      "Stripe",
      "TypeScript",
    ...
    projectLink: "https://waivify.com",
    githubLink: "https://github.com/DustinHeaps/waivify-app",
  },
  {
    id: 2,
    title: "DevOverflow",
